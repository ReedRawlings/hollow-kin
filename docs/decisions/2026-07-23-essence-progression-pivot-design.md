...
- **Breeding Stones** — cut for now (`docs/archive/retired/breeding-stones.md` retired). They were Enhancer consumables; the Enhancer no longer exists.
- **Longevity** — removed.
...
| Doc | Change |
|---|---|
| `docs/design/game-design-document.md` | Rewrite Core Philosophy pillar, run structure, add essence system |
| `docs/design/economy-balancing.md` | Essence resource, earn/spend, level cost curve, depth-jump prices, remove plasm |
| `docs/design/breeding-and-inheritance.md` | Carry-over, star/essence relationship |
| `docs/design/traits-system.md` | Trait unlocks → essence thresholds; delete star table |
| `docs/design/marks-system.md` + `marks-catalog` | Earn-then-lock permanence via essence; re-peg thresholds |
| `docs/design/tower-structure.md` | Single 30-floor descent, boss cadence, essence depth-jumps |
| `docs/design/town.md` | Essence hub + vendors |
| `docs/archive/retired/breeding-stones.md` | Retire / mark as cut |
| `CLAUDE.md` | Revise "Key Design Rules"; update state notes |
| `MEMORY (agent memory, outside the repo)` | Reflect the pivot |
