...
* The essence-hub vendors — Creature Box, Leveler, Trait-keeper, the Ledger (reading only), Gatekeeper, Quartermaster, Breeder
...
* **Marks:** Deeds this Kin discovered (name, run, what it unlocked). Read-only — marks are not equipped or swapped.
...
Header, Essence should be visible on initial scan. Selecting into a creature should show its Stats Block, Traits, Marks, Abilities. Lineage is another subscreen to this as most players will not care to see it.
...
| Marks | Shield or crest shape (a recorded deed, not an equip) | Silver / archetype color |
...
* Animation and feedback design for key moments: breeding, trait unlock, mark discovered, star increase
