...
export const FAMILY_RITES: Record<Archetype, RiteDef> = {
  ...
  Kami: {
    ...
    conditions: [{ kind: 'damage_type_taken', damageType: 'Bell' }],
  },
  // This creature is hit with a physical attack.
  Slimes: {
    id: 'rite_family_slimes', band: 'family', persistence: 'sticky',
    conditions: [{ kind: 'damage_type_taken', damageType: 'Iron' }],
  },
  ...
  Mecha: {
    ...
    conditions: [
      { kind: 'damage_type_dealt', damageType: 'Ash' },
      { kind: 'damage_type_dealt', damageType: 'Bell' },
    ],
  },
  // A fire attack is used twice in battle.
  Dragon: {
    id: 'rite_family_dragon', band: 'family', persistence: 'sticky',
    conditions: [{ kind: 'damage_type_dealt', damageType: 'Ash', times: 2 }],
  },
};
...
export const CREATURE_TEMPLATES: Record<string, CreatureTemplate> = {
  kin_002: {
    ...
    resistances: ['Breath'], weaknesses: ['Honey'],
    spriteColor: ARCHETYPE_COLORS.Spirits,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'evasion_up', 'resist_mirror', 'essence_distiller'],
  ...
  kin_007: {
    ...
    resistances: ['Thorn'], weaknesses: ['Iron'],
    spriteColor: ARCHETYPE_COLORS.Spirits,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'evasion_up', 'resist_mirror'],
  ...
  kin_011: {
    ...
    resistances: ['Ash'], weaknesses: ['Breath'],
    spriteColor: ARCHETYPE_COLORS.Spirits,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'evasion_up', 'resist_mirror'],
  ...
  kin_013: {
    ...
    defaultAbilities: ['combfall', 'bold'],
    resistances: ['Honey'], weaknesses: ['Iron'],
    spriteColor: ARCHETYPE_COLORS.Food,
    naturalTraitPool: ['str_up', 'hp_up', 'opening_buff', 'kin_bond', 'resist_status', 'resist_honey'],
  ...
  kin_017: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['cloy', 'focus'],
    resistances: ['Salt'], weaknesses: ['Ash'],
    spriteColor: ARCHETYPE_COLORS.Food,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'kin_bond', 'resist_status', 'resist_honey'],
  ...
  kin_020: {
    ...
    defaultAbilities: ['cloy', 'soothe'],
    resistances: ['Mirror'], weaknesses: ['Salt'],
    spriteColor: ARCHETYPE_COLORS.Food,
    naturalTraitPool: ['wis_up', 'hp_up', 'resist_status', 'kin_bond', 'resist_honey'],
  ...
  kin_029: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['thicket', 'weaken'],
    resistances: ['Thorn'], weaknesses: ['Mirror'],
    spriteColor: ARCHETYPE_COLORS.Flora,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'kin_bond', 'resist_breath', 'resist_thorn'],
  ...
  kin_037: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['thicket', 'focus'],
    resistances: ['Bell'], weaknesses: ['Salt'],
    spriteColor: ARCHETYPE_COLORS.Flora,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'kin_bond', 'resist_breath', 'resist_thorn'],
  ...
  kin_038: {
    ...
    resistances: ['Bane'], weaknesses: ['Ash'],
  ...
  kin_046: {
    ...
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['ember', 'focus'],
    resistances: ['Honey'], weaknesses: ['Bell'],
    spriteColor: ARCHETYPE_COLORS.Devils,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'evasion_up', 'resist_mirror'],
  ...
  kin_050: {
    ...
    resistances: ['Mirror'], weaknesses: ['Iron'],
    spriteColor: ARCHETYPE_COLORS.Slimes,
    naturalTraitPool: ['wis_up', 'hp_up', 'resist_status', 'kin_bond', 'resist_iron', 'essence_distiller'],
  ...
  kin_054: {
    ...
    resistances: ['Breath'], weaknesses: ['Mirror'],
    spriteColor: ARCHETYPE_COLORS.Slimes,
    naturalTraitPool: ['str_up', 'hp_up', 'opening_buff', 'kin_bond', 'resist_iron'],
  ...
  kin_059: {
    ...
    baseStats: { hp: 42, mp: 21, str: 16, def: 11, wis: 10, spd: 10, int: 8 },
    defaultAbilities: ['smash', 'bold'],
    resistances: ['Ash'], weaknesses: ['Iron'],
  ...
  kin_061: {
    ...
    resistances: ['Ash'], weaknesses: ['Iron'],
    spriteColor: ARCHETYPE_COLORS.Rock,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'kin_bond', 'resist_iron'],
  ...
  kin_070: {
    ...
    resistances: ['Honey'], weaknesses: ['Mirror'],
  ...
  kin_075: {
    ...
    resistances: ['Salt'], weaknesses: ['Iron'],
    spriteColor: ARCHETYPE_COLORS.Fauna,
    naturalTraitPool: ['hp_up', 'def_up', 'opening_ward', 'opening_block', 'kin_bond', 'resist_iron'],
  ...
  kin_080: {
    ...
    resistances: ['Mirror'], weaknesses: ['Breath'],
    spriteColor: ARCHETYPE_COLORS.Fauna,
    naturalTraitPool: ['wis_up', 'hp_up', 'resist_status', 'kin_bond', 'resist_iron'],
  ...
  kin_087: {
    ...
    resistances: ['Honey'], weaknesses: ['Rust'],
    spriteColor: ARCHETYPE_COLORS.Kami,
    naturalTraitPool: ['str_up', 'hp_up', 'opening_buff', 'resist_status', 'resist_salt', 'essence_distiller'],
  ...
  kin_091: {
    ...
    baseStats: { hp: 42, mp: 21, str: 16, def: 11, wis: 10, spd: 10, int: 8 },
    defaultAbilities: ['frost', 'bold'],
    resistances: ['Bell'], weaknesses: ['Iron'],
    spriteColor: ARCHETYPE_COLORS.Kami,
    naturalTraitPool: ['str_up', 'hp_up', 'opening_buff', 'resist_status', 'resist_salt'],
  ...
  kin_092: {
    ...
    resistances: ['Rust'], weaknesses: ['Honey'],
    spriteColor: ARCHETYPE_COLORS.Kami,
    naturalTraitPool: ['hp_up', 'def_up', 'opening_ward', 'opening_block', 'resist_status', 'resist_salt'],
  ...
  kin_098: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['crackle', 'overdrive'],
    resistances: ['Mirror'], weaknesses: ['Breath'],
    spriteColor: ARCHETYPE_COLORS.Human,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'kami_slayer', 'resist_iron'],
  ...
  kin_099: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['crackle', 'weaken'],
    resistances: ['Mirror'], weaknesses: ['Bell'],
    spriteColor: ARCHETYPE_COLORS.Human,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'kami_slayer', 'resist_iron'],
  ...
  kin_107: {
    ...
    resistances: ['Breath'], weaknesses: ['Honey'],
    spriteColor: ARCHETYPE_COLORS.Human,
    naturalTraitPool: ['hp_up', 'def_up', 'opening_ward', 'opening_block', 'kami_slayer', 'resist_iron'],
  ...
  kin_110: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['tarnish', 'focus'],
    resistances: ['Ash'], weaknesses: ['Rust'],
    spriteColor: ARCHETYPE_COLORS.Mecha,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'initiative_boost', 'resist_bell', 'resist_rust'],
  ...
  kin_116: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 45, mp: 26, str: 7, def: 10, wis: 14, spd: 7, int: 9 },
    defaultAbilities: ['tarnish', 'mend'],
    resistances: ['Bane'], weaknesses: ['Rust'],
    spriteColor: ARCHETYPE_COLORS.Mecha,
    naturalTraitPool: ['wis_up', 'hp_up', 'resist_status', 'initiative_boost', 'resist_bell', 'resist_rust'],
  ...
  kin_118: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 55, mp: 15, str: 13, def: 17, wis: 8, spd: 4, int: 5 },
    defaultAbilities: ['tarnish', 'harden'],
    resistances: ['Bane'], weaknesses: ['Rust'],
    spriteColor: ARCHETYPE_COLORS.Mecha,
    naturalTraitPool: ['hp_up', 'def_up', 'opening_ward', 'opening_block', 'initiative_boost', 'resist_bell', 'resist_rust'],
  ...
  kin_123: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 33, mp: 29, str: 8, def: 7, wis: 12, spd: 14, int: 15 },
    defaultAbilities: ['nightshade', 'focus'],
    resistances: ['Ash'], weaknesses: ['Thorn'],
    spriteColor: ARCHETYPE_COLORS.Dragon,
    naturalTraitPool: ['int_up', 'mp_up', 'wis_up', 'initiative_boost', 'resist_ash', 'resist_bane'],
  ...
  kin_124: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 42, mp: 21, str: 16, def: 11, wis: 10, spd: 10, int: 8 },
    defaultAbilities: ['nightshade', 'bold'],
    resistances: ['Thorn'], weaknesses: ['Ash'],
    spriteColor: ARCHETYPE_COLORS.Dragon,
    naturalTraitPool: ['str_up', 'hp_up', 'opening_buff', 'initiative_boost', 'resist_ash', 'resist_bane'],
  ...
  kin_125: {
    ...
    towerIds: [1, 2],
    baseStats: { hp: 45, mp: 26, str: 7, def: 10, wis: 14, spd: 7, int: 9 },
    defaultAbilities: ['nightshade', 'soothe'],
    resistances: ['Ash'], weaknesses: ['Thorn'],
    spriteColor: ARCHETYPE_COLORS.Dragon,
    naturalTraitPool: ['wis_up', 'hp_up', 'resist_status', 'initiative_boost', 'resist_ash', 'resist_bane'],
...
/**
 * The Founding Hand's authored tutorial loadouts. These replace the species defaults
 * only when the Kin are granted as new-game starters; wild and bred instances keep
 * their normal archetype/role moves. Keeping this beside STARTER_TRIO_A gives combat
 * prototypes one canonical source for the moves the player actually starts with.
 */
export const STARTER_HAND_LOADOUTS: Readonly<Record<string, readonly string[]>> = {
  kin_070: ['jab', 'slash'],
